...
public class MarkdownMessageDto : MessageBase
{
    public MarkdownMessageDto(string message, Room room, Channel channel, string replyMessageId = "",
        User[]? atUser = null,
    ...
    public MarkdownMessageDto(string message, string roomId, string channelId, string replyMessageId = "",
        string[]? atUser = null,
